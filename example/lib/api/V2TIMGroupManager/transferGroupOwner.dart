...
class TransferGroupOwner extends StatefulWidget {
  ...
  State<StatefulWidget> createState() {
    return _TransferGroupOwnerState();
  }
}

class _TransferGroupOwnerState extends State<TransferGroupOwner> {
  String result = '';
  List<String> friends = [];
  List<String> groups = [];
  String selectedId = '';
  ...
  pressedFunction() async {
    ...
    setState(() {
      result = transferGroupOwnerRes.toJson().toString();
    });
  }
