...
class GetGroupOnlineMemberCount extends StatefulWidget {
  ...
  State<StatefulWidget> createState() {
    return _GetGroupOnlineMemberCountState();
  }
}

class _GetGroupOnlineMemberCountState extends State<GetGroupOnlineMemberCount> {
  String result = '';
  List<String> friends = [];
  List<String> groups = [];
  String selectedId = '';
  ...
  pressedFunction() async {
    ...
    setState(() {
      result = getGroupOnlineMemberCountRes.toJson().toString();
    });
  }
  ...
  Widget build(BuildContext context) {
    ...
    return MaterialApp(
      ...
      appBar: AppBar(
        ...
        title: Text('GetGroupOnlineMemberCount'),
      ),
      body: Center(
        child: Column(
          children: [
