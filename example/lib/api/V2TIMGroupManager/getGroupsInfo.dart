...
class GetGroupsInfo extends StatefulWidget {
  ...
  State<StatefulWidget> createState() {
    return _GetGroupsInfoState();
  }
}

class _GetGroupsInfoState extends State<GetGroupsInfo> {
  String result = '';
  List<String> friends = [];
  List<String> groups = [];
  String selectedId = '';
  ...
  pressedFunction() async {
    V2TimValueCallback<List<V2TimGroupInfoResult>> getGroupsInfoRes =
        await TencentImSDKPlugin.v2TIMManager
            .getGroupManager()
            .getGroupsInfo(groupIDList: [selectedGroup]);
    setState(() {
      result = getGroupsInfoRes.toJson().toString();
    });
  }
