...
class AddFriendsToFriendGroup extends StatefulWidget {
  ...
  State<StatefulWidget> createState() {
    return _AddFriendsToFriendGroupState();
  }
}

class _AddFriendsToFriendGroupState extends State<AddFriendsToFriendGroup> {
  String result = '';
  List<String> friends = [];
  List<String> groups = [];
  String selectedId = '';
    ...
    V2TimValueCallback<List<V2TimFriendOperationResult>>
        addFriendsToFriendGroupRes = await TencentImSDKPlugin.v2TIMManager
            ...
            .addFriendsToFriendGroup(
                groupName: selectedGroup, //分组名称
                userIDList: [selectedId] //需要加入分组的好友id
                );
    setState(() {
      result = addFriendsToFriendGroupRes.toJson().toString();
    });
  }
  ...
  Widget build(BuildContext context) {
    ...
    return MaterialApp(
      ...
      appBar: AppBar(
        ...
        title: Text('AddFriendsToFriendGroup'),
      ),
      body: Center(
        child: Column(
          children: [
