...
class DeleteMessageExtensions extends StatefulWidget {
  @override
  State<StatefulWidget> createState() {
    return _DeleteMessageExtensionsState();
  }
}

class _DeleteMessageExtensionsState extends State<DeleteMessageExtensions> {
  String result = '';
  List<String> friends = [];
  List<String> groups = [];
    ...
    V2TimValueCallback<List<V2TimMessageExtensionResult>>
        deleteMessageExtensionsRes = await TencentImSDKPlugin.v2TIMManager
            ...
            .deleteMessageExtensions(
                msgID: selectedMessage.msgID!, // 需要删除扩展的消息id
                keys: [_statusController.text]);
    setState(() {
      result = deleteMessageExtensionsRes.toJson().toString();
    });
  }
  ...
  Widget build(BuildContext context) {
    ...
    return MaterialApp(
      ...
      appBar: AppBar(
        ...
        title: Text('DeleteMessageExtensions'),
      ),
      body: Center(
        child: Column(
          children: [
            ...
            ElevatedButton(
              child: Text('DeleteMessageExtensions'),
              onPressed: () {
                pressedFunction();
              },
            ),
