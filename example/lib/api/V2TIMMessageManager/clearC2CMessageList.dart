...
class ClearC2CMessageList extends StatefulWidget {
  @override
  State<StatefulWidget> createState() {
    return _ClearC2CMessageListState();
  }
}

class _ClearC2CMessageListState extends State<ClearC2CMessageList> {
  String result = '';
  List<String> friends = [];
  String selectedId = '';
  ...
  pressedFunction() async {
    V2TimCallback clearC2CHistoryMessageRes = await TencentImSDKPlugin
        .v2TIMManager
        .getMessageManager()
        .clearC2CHistoryMessage(userID: selectedId); // 需要清空记录的用户id
    setState(() {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      appBar: AppBar(
        ...
        title: Text('ClearC2CMessageList'),
      ),
      body: Center(
        child: Column(
          children: [
            ...
            ElevatedButton(
              child: Text('ClearC2CMessageList'),
              onPressed: () {
                pressedFunction();
              },
            ),
