...
class GetMessageExtensions extends StatefulWidget {
  @override
  State<StatefulWidget> createState() {
    return _GetMessageExtensionsState();
  }
}

class _GetMessageExtensionsState extends State<GetMessageExtensions> {
  String result = '';
  List<String> friends = [];
  List<String> groups = [];
    ...
    V2TimValueCallback<List<V2TimMessageExtension>> getMessageExtensionsRes =
        await TencentImSDKPlugin.v2TIMManager
            ...
            .getMessageExtensions(
              msgID: selectedMessage.msgID!, // 需要获取扩展信息的消息id
            );
    setState(() {
      result = getMessageExtensionsRes.toJson().toString();
    });
  }
  ...
  Widget build(BuildContext context) {
    ...
    return MaterialApp(
      ...
      appBar: AppBar(
        ...
        title: Text('GetMessageExtensions'),
      ),
      body: Center(
        child: Column(
          children: [
            ...
            ElevatedButton(
              child: Text('GetMessageExtensions'),
              onPressed: () {
                pressedFunction();
              },
            ),
