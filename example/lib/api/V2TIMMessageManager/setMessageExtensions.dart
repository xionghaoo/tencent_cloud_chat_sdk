...
class SetMessageExtensions extends StatefulWidget {
  @override
  State<StatefulWidget> createState() {
    return _SetMessageExtensionsState();
  }
}

class _SetMessageExtensionsState extends State<SetMessageExtensions> {
  String result = '';
  List<String> friends = [];
  List<String> groups = [];
    ...
    V2TimValueCallback<List<V2TimMessageExtensionResult>>
        setMessageExtensionsRes = await TencentImSDKPlugin.v2TIMManager
            ...
            .setMessageExtensions(
                msgID: selectedMessage.msgID!, // 需要扩展的消息id
                extensions: [
          V2TimMessageExtension(
              extensionKey: _statusController.text,
              extensionValue: _messageController.text)
        ]);
    setState(() {
      result = setMessageExtensionsRes.toJson().toString();
    });
  }
  ...
  Widget build(BuildContext context) {
    ...
    return MaterialApp(
      ...
      appBar: AppBar(
        ...
        title: Text('SetMessageExtensions'),
      ),
      body: Center(
        child: Column(
          children: [
            ...
            TextField(
              ...
              decoration: InputDecoration(
                  labelText: "extension value",
                  hintText: "extension value",
                  prefixIcon: Icon(Icons.person)),
            ),
            const SizedBox(
              height: 20,
            ...
            ElevatedButton(
              child: Text('SetMessageExtensions'),
              onPressed: () {
                pressedFunction();
              },
            ),
