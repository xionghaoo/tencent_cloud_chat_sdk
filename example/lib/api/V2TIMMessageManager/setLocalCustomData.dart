...
class SetLocalCustomData extends StatefulWidget {
  ...
  State<StatefulWidget> createState() {
    return _SetLocalCustomDataState();
  }
}

class _SetLocalCustomDataState extends State<SetLocalCustomData> {
  String result = '';
  List<String> friends = [];
  List<String> groups = [];
  ...
  pressedFunction() async {
    V2TimCallback setLocalCustomDataRes = await TencentImSDKPlugin.v2TIMManager
        ...
        .setLocalCustomData(
            ...
            localCustomData: "localCustomData/example/flutter");
    setState(() {
      result = setLocalCustomDataRes.toJson().toString();
    });
  }
