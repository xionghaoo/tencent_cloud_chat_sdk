...
class DeleteMessageFromLocalStorage extends StatefulWidget {
  ...
  State<StatefulWidget> createState() {
    return _DeleteMessageFromLocalStorageState();
  }
}

class _DeleteMessageFromLocalStorageState
  ...
  pressedFunction() async {
    V2TimCallback deleteMessageFromLocalStorageRes = await TencentImSDKPlugin
        .v2TIMManager
        .getMessageManager()
        .deleteMessageFromLocalStorage(msgID: selectedMessage.msgID!);
    setState(() {
      result = deleteMessageFromLocalStorageRes.toJson().toString();
    });
  }
  ...
  Widget build(BuildContext context) {
    ...
    return MaterialApp(
      ...
      appBar: AppBar(
        ...
        title: Text('DeleteMessageFromLocalStorage'),
      ),
      body: Center(
        child: Column(
          children: [
