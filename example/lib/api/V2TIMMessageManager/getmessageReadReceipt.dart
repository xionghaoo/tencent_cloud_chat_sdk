...
class GetMessageReadReceipt extends StatefulWidget {
  ...
  State<StatefulWidget> createState() {
    return _GetMessageReadReceiptState();
  }
}
...
class _GetMessageReadReceiptState extends State<GetMessageReadReceipt> {
  ...
  pressedFunction() async {
    V2TimValueCallback<List<V2TimMessageReceipt>> getMessageReadReceipts =
        await TencentImSDKPlugin.v2TIMManager
            .getMessageManager()
            .getMessageReadReceipts(messageIDList: [selectedMessage.msgID!]);
    setState(() {
      result = getMessageReadReceipts.toJson().toString();
    });
  }
  ...
  Widget build(BuildContext context) {
    ...
    return MaterialApp(
      ...
      appBar: AppBar(
        ...
        title: Text('GetMessageReadReceipt'),
      ),
      body: Center(
        child: Column(
          children: [
            ...
            ElevatedButton(
              child: Text('GetMessageReadReceipt'),
              onPressed: () {
                pressedFunction();
              },
            ),
