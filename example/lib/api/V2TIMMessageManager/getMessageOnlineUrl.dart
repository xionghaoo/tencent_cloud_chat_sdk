...
class GetMessageOnlineUrl extends StatefulWidget {
  @override
  State<StatefulWidget> createState() {
    return _GetMessageOnlineUrlState();
  }
}

class _GetMessageOnlineUrlState extends State<GetMessageOnlineUrl> {
  String result = '';
  List<String> friends = [];
  List<String> groups = [];
  ...
  pressedFunction() async {
    ...
    setState(() {
      result = getMessageOnlineUrlRes.toJson().toString();
    });
  }
  ...
  Widget build(BuildContext context) {
    ...
    return MaterialApp(
      ...
      appBar: AppBar(
        ...
        title: Text('GetMessageOnlineUrl'),
      ),
      body: Center(
        child: Column(
          children: [
            ...
            ElevatedButton(
              child: Text('GetMessageOnlineUrl'),
              onPressed: () {
                pressedFunction();
              },
            ),
