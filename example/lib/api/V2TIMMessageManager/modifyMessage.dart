...
class ModifyMessage extends StatefulWidget {
  ...
  State<StatefulWidget> createState() {
    return _ModifyMessageState();
  }
}

class _ModifyMessageState extends State<ModifyMessage> {
  String result = '';
  List<String> friends = [];
  List<String> groups = [];
  ...
  pressedFunction() async {
    selectedMessage.cloudCustomData = _statusController.text;
    V2TimValueCallback<V2TimMessageChangeInfo> modifyMessageRes =
        await TencentImSDKPlugin.v2TIMManager
            .getMessageManager()
            .modifyMessage(message: selectedMessage);
    setState(() {
      result = modifyMessageRes.toJson().toString();
    });
  }
