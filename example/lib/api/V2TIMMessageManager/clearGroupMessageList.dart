...
class ClearGroupMessageList extends StatefulWidget {
  @override
  State<StatefulWidget> createState() {
    return _ClearGroupMessageListState();
  }
}

class _ClearGroupMessageListState extends State<ClearGroupMessageList> {
  String result = '';
  List<String> groups = [];
  ...
  pressedFunction() async {
    V2TimCallback clearGroupHistoryMessageRes = await TencentImSDKPlugin
        .v2TIMManager
        .getMessageManager()
        .clearGroupHistoryMessage(groupID: selectedGroup);
    setState(() {
      result = clearGroupHistoryMessageRes.toJson().toString();
    });
  }
      ...
      body: Center(
        child: Column(
          children: [
            ...
            ElevatedButton(
              child: Text('ClearGroupMessageList'),
              onPressed: () {
                pressedFunction();
              },
            ),
