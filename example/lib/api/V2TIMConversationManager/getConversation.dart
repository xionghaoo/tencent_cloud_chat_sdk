...
class GetConversation extends StatefulWidget {
  ...
  State<StatefulWidget> createState() {
    return _GetConversationState();
  }
}

class _GetConversationState extends State<GetConversation> {
  String result = '';
  ...
  pressedFunction() async {
    V2TimValueCallback<V2TimConversation> getConversationtRes =
        await TencentImSDKPlugin.v2TIMManager
            .getConversationManager()
            .getConversation(conversationID: selectedId);
    setState(() {
      result = getConversationtRes.toJson().toString();
    });
  }
