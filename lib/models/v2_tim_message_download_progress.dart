...
class V2TimMessageDownloadProgress {
  ...
  String toLogString() {
    String res = "isFinish:$isFinish|isError:$isError|msgID:$msgID|currentSize:$currentSize|totalSize:$totalSize|type:$type|isSnapshot:$isSnapshot|errorCode:$errorCode|errorDesc:$errorDesc";
    return res;
  }
}
